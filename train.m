...
for kkkk=1:5
    ...
    azmpara = [1,floor(1000*ss(kkkk))];
    [train_azm_row,~,~,~,train_vel_in_azm]...
        = balandata(train_azm_1,train_mag_1,train_psi_1,train_alpha_1,train_vel_input,...
        azmpara(1),azmpara(2));
    ...
    train_input{5} = train_vel_in_azm;
    train_output{5} = train_azm_row;
    train_input{6} = train_vel_in_bt;
    train_output{6} = train_bt_alpha_row;
...
save iquvv_net BPprealltrain netw parainput train_input train_output
